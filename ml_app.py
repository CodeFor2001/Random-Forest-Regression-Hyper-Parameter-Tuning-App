# -*- coding: utf-8 -*
"""
Created on Mon May 10 16:06:13 2021
...
def build_model(df):
    ...
    st.markdown("**Training and test set details**")
    st.write("X variable, i.e., columns in training set")
    st.info(X.columns)
    st.write("Y variable, i.e., columns in test set")
    st.info(Y.name)
